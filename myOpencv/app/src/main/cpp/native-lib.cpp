...
//Java_com_example_myopencv_MainActivity_ConvertRGBtoGray(JNIEnv *env, jobject instance,
...
//    cvtColor(matInput, matResult, COLOR_BGR2BGRA);
...
Java_com_example_myopencv_MainActivity_loadCascade(JNIEnv *env, jobject instance,
...
Java_com_example_myopencv_MainActivity_detect(JNIEnv *env, jobject instance,
